# -*- coding: utf-8 -*-
# Generated by Django 1.11.25 on 2020-02-04 15:50
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mistake_tag', models.SmallIntegerField(choices=[(0, '正常'), (1, '货数被并'), (2, '导入重复'), (3, '工厂非法'), (4, '货品非法'), (5, '其他错误')], default=0, verbose_name='问题原因')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('owner', models.CharField(max_length=50, verbose_name='货主')),
                ('memorandum', models.CharField(blank=True, max_length=200, null=True, verbose_name='备注')),
                ('order_id', models.CharField(max_length=60, unique=True, verbose_name='单据编号')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('batch_number', models.CharField(db_index=True, max_length=60, verbose_name='批号')),
                ('warehouse', models.CharField(db_index=True, max_length=60, verbose_name='仓库')),
                ('expiry_date', models.DateTimeField(max_length=60, verbose_name='有效期至')),
                ('produce_time', models.DateTimeField(max_length=60, verbose_name='生产日期')),
                ('memorandum', models.CharField(blank=True, max_length=200, null=True, verbose_name='备注')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('error_tag', models.SmallIntegerField(choices=[(0, '正常'), (1, '重复递交'), (2, '仓库非法'), (3, '部门非法'), (4, '货品非法')], default=0, verbose_name='递交错误原因')),
                ('order_status', models.SmallIntegerField(choices=[(0, '已取消'), (1, '待递交'), (2, '已完成')], default=1, verbose_name='状态')),
            ],
            options={
                'verbose_name': 'wms-原始出库单查询',
                'verbose_name_plural': 'wms-原始出库单查询',
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'verbose_name_plural': 'wms-原始入库单未递交',
                'proxy': True,
                'indexes': [],
            },
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'verbose_name_plural': 'wms-原始出库单处理',
                'proxy': True,
                'indexes': [],
            },
