    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('si_tag', models.SmallIntegerField(choices=[(0, '否'), (1, '是')], default=0, verbose_name='入库创建')),
                ('so_tag', models.SmallIntegerField(choices=[(0, '否'), (1, '是')], default=0, verbose_name='出库创建')),
                ('order_status', models.SmallIntegerField(choices=[(0, '已取消'), (1, '未递交'), (2, '已递交')], default=1, verbose_name='状态')),
                ('mistake_tag', models.SmallIntegerField(choices=[(0, '正常'), (1, '重复递交'), (2, '供货商非法'), (3, '部门非法'), (4, '货品非法'), (5, '仓库非法'), (6, '实例保存错误'), (7, '入库保存错误'), (8, '出库保存错误')], default=0, verbose_name='问题原因')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_category', models.CharField(max_length=60, verbose_name='单据类型')),
                ('ori_creator', models.CharField(max_length=60, verbose_name='创建人')),
                ('supplier', models.CharField(blank=True, max_length=60, null=True, verbose_name='供货方')),
                ...
                ('goods_name', models.CharField(max_length=60, verbose_name='物料名称')),
                ('goods_size', models.CharField(max_length=60, verbose_name='规格型号')),
                ('goods_unit', models.CharField(blank=True, max_length=60, null=True, verbose_name='库存单位')),
