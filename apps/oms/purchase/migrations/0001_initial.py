# -*- coding: utf-8 -*-
# Generated by Django 1.11.25 on 2020-02-22 12:22
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_id', models.CharField(db_index=True, max_length=50, verbose_name='采购单号')),
                ...
                ('mistake_tag', models.SmallIntegerField(choices=[(0, '正常'), (1, '采购状态错误')], default=0, verbose_name='错误原因')),
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'verbose_name_plural': 'oms-采购单追踪',
                'proxy': True,
                'indexes': [],
            },
            bases=('purchase.purchaseinfo',),
        ),
