...
class CovertLoss(BaseModel):
    ...
    des_department = models.ForeignKey(DepartmentInfo, on_delete=models.CASCADE, null=True, blank=True, verbose_name='目标部门')
...
class CovertLOUnhandle(CovertLoss):
