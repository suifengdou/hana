    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('supplier', models.CharField(blank=True, max_length=160, null=True, verbose_name='供货方')),
                ('create_date', models.DateTimeField(verbose_name='创建日期')),
                ('seller', models.CharField(blank=True, max_length=60, null=True, verbose_name='结算方')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_delete', models.BooleanField(default=False, verbose_name='删除标记')),
                ('creator', models.CharField(blank=True, max_length=90, null=True, verbose_name='创建者')),
                ('order_id', models.CharField(db_index=True, max_length=30, unique=True, verbose_name='出库调整单单号')),
                ('si_order_id', models.CharField(blank=True, max_length=300, null=True, verbose_name='入库调整单单号')),
                ('order_status', models.SmallIntegerField(choices=[(0, '已取消'), (1, '已完成')], default=1, verbose_name='状态')),
            ],
            options={
                'verbose_name': 'oms-出库调整单已出库列表',
                'verbose_name_plural': 'oms-出库调整单已出库列表',
