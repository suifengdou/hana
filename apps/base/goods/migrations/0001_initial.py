    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('logistics_time', models.IntegerField(blank=True, null=True, verbose_name='物流周期（天）')),
                ('order_time', models.IntegerField(blank=True, null=True, verbose_name='订货周期（天）')),
                ...
                ('manufactory', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='company.ManuInfo', verbose_name='供应商')),
            ],
            options={
